...
Connection con = DriverManager.getConnection("jdbc:mysql://cs336test.c7y8oeljbznd.us-east-2.rds.amazonaws.com:3306/CustomerLogin",
		"moussa","league12");
...
if (rs.next()) {
	...
	response.sendRedirect("sueccess.jsp");
} else {
